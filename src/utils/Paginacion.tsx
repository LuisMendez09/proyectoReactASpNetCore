...
export default function Paginacion(props: paginacionProps){
    const[listaLinks,setListadoLinks] = useState<modeloLink[]>([])
    ...
    useEffect(()=>{
        ...
        const paginaSiguienteHabilitada = props.paginaActual!==props.cantidadTotalPagina &&
                                          props.cantidadTotalPagina>0; 
    ...
    return(
        <nav>
            <ul className='pagination justify-content-center'>
                {listaLinks.map(link=><li key={link.texto}
